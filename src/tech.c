...
dotech()
{
	...
	if (gettech(&tech_no)) {
		...
		case T_TOILET_VISIT:
			pline("If you want to play trap 2 minigame where you visit the public toilet, you can use this technique. You will also gain maximum health and cure sickness when doing so.");
			break;
...
cardtrickchoice:
		...
		case T_S_PRESSING:
			...
			if (practicantterror) {
				pline("%s thunders: 'You practicant lass! Your act will not be tolerated! Now you pay 5000 zorkmids?'", noroelaname());
