...
int duration;
{
	...
	switch (rnd(78)) {
		...
		case 8:
			...
			break;
		case 9:
			pline("Suddenly, you feel that you're going to step into a heap.");
		...
		case 38:
			...
			break;
		case 39:
			pline("A heinously evil woman plans to force you to clean all kinds of female shoes...");
		...
		case 42:
			...
			break;
		case 43:
			pline("You feel that someone is going to open the zippers of your boots, making you fumble into a heap.");
		...
		case 57:
			...
			break;
		case 58:
			pline("You are commanded to seek out heaps and step into it with your high heels. Something tells you that there are bad consequences if you don't obey this instruction.");
		...
		case 62:
			...
			break;
		case 63:
			pline("Watch out, walking over the bridge has a large chance of you stepping into a heap!");
