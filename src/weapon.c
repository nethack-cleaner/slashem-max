...
{	
	...
	ALIGNMENT_STONE, STAIRSTRAP_STONE, EGOSTONE, FAST_FORWARD_STONE,
	FARLOOK_STONE, RESPAWN_STONE, CAPTCHA_STONE, METABOLIC_STONE, STONE_OF_NO_RETURN, TIME_USE_STONE,
 	...
 	STEALER_STONE, REBEL_STONE, STONE_OF_MISFIRING, STONE_OF_PERMANENCE,
	...
	MONNOISE_STONE, RANG_CALL_STONE, ANTI_TRAINING_STONE, TECHOUT_STONE,
	...
	PARANOIA_STONE, FLEECE_STONE, INTERRUPTION_STONE, DUSTBIN_STONE, BATTERY_STONE,
	...
	GREEN_SPELL_STONE, EVC_STONE, UNDERLAID_STONE, DAMAGE_METER_STONE, WEIGHT_STONE,
	...
	SING_S_JEWEL, INA_S_JEWEL, DORA_S_JEWEL, ANNEMARIE_S_JEWEL, JIL_S_JEWEL, JANA_S_JEWEL, KATRIN_S_JEWEL, 	GUDRUN_S_JEWEL, ELLA_S_JEWEL, MANUELA_S_JEWEL, JENNIFER_S_JEWEL, PATRICIA_S_JEWEL,
	KERSTIN_S_JEWEL, LAURA_S_JEWEL, LARISSA_S_JEWEL, NORA_S_JEWEL, NATALIA_S_JEWEL,
...
{	PETRIFYIUM_BAR, DISINTEGRATION_BAR, NASTYPOLE, GREAT_POLLAX, WOODEN_BAR, TRAFFIC_LIGHT, GIANT_SCYTHE,
	...
	GLAIVE, LUCERN_HAMMER, BEC_DE_CORBIN, FAUCHARD, ETERNAL_POLE, LONG_POLE, SHARP_POLE, PIKE,
...
static const NEARDATA short hwep[] = {
	  ...
	  COLOSSUS_BLADE, THUNDER_HAMMER, HONOR_KATANA,
	  CHAINSWORD, TSURUGI, DROVEN_GREATSWORD, DWARVISH_BATTLE_AXE, TWO_HANDED_TRIDENT,
	  ...
	  BENT_SABLE, HOE_SABLE, MYTHICAL_SABLE, MARBLE_CHUNK, LASERXBOW,
	  LIGHTWHIP, ELECTRIC_CIGARETTE, NANO_HAMMER, LASER_SWATTER, STARWARS_MACE,
	  ...
	  ORGANOBLADE, GUITAR, DARK_HORN, SHADOWBLADE, ROMAN_SWORD, ETHER_SAW, SKY_HORN,
	  ...
	  CHROME_STAFF, CONTRO_STAFF, CALCULATOR, ELITE_BATLETH, RAKUYO, CROW_QUILL,
...
#endif
{
	...
	do {
		...
		/* stupidity... If you have the skill and trained it while being polymorphed,
		 * then there's ZERO REASON TO NOT SHOW IT IN THE DUMP!!! --Amy */
...
struct obj *weapon;
{
	...
	if (Race_if(PM_INKA) && weapon && (weapon->otyp == INKA_BLADE || weapon->otyp == INKUTLASS || weapon->otyp == NATURAL_STICK || weapon->otyp == VERMIN_SWATTER || weapon->otyp == INKA_SPEAR || weapon->otyp == INKA_STINGER || weapon->otyp == INKA_SHACKLE )) bonus += 2;
...
boolean extraskills;
{
	...
	if (obj->otyp == PET_STOMPING_PLATFORM_BOOTS || obj->otyp == ATSUZOKO_BOOTS || obj->otyp == COMBAT_STILETTOS || obj->otyp == ITALIAN_HEELS || obj->otyp == LADY_BOOTS || obj->otyp == STILETTO_SANDALS || obj->otyp == HIGH_STILETTOS || obj->otyp == UNFAIR_STILETTOS || obj->otyp == SKY_HIGH_HEELS || obj->otyp == SINFUL_HEELS || obj->otyp == COVETED_BOOTS || obj->otyp == BUM_BUM_BOOTS || obj->otyp == SELF_WILLED_HEELS || obj->otyp == HIGH_HEELED_SKIERS || obj->otyp == RED_SPELL_HEELS || obj->otyp == DESTRUCTIVE_HEELS || obj->otyp == LONG_POINTY_HEELS || obj->otyp == VIOLET_BEAUTY_HEELS || obj->otyp == AUTOSCOOTER_HEELS || obj->otyp == KILLER_HEELS || obj->otyp == HIGH_SCORING_HEELS || obj->otyp == FEMMY_STILETTO_BOOTS || obj->otyp == MADELEINE_PLATEAU_BOOTS || obj->otyp == WENDY_LEATHER_PUMPS || obj->otyp == KATHARINA_PLATFORM_BOOTS || obj->otyp == NADJA_BUCKLED_LADY_SHOES || obj->otyp == NATALJE_BLOCK_HEEL_SANDALS || obj->otyp == CLAUDIA_WOODEN_SANDALS || obj->otyp == GUDRUN_WEDGE_SANDALS || obj->otyp == ANNEMARIE_PLATFORM_SANDALS) skill = P_HIGH_HEELS;

	if (obj->otyp == RUBBER_BOOTS || obj->otyp == SNEAKERS || obj->otyp == DANCING_SHOES || obj->otyp == SWEET_MOCASSINS || obj->otyp == SOFT_SNEAKERS || obj->otyp == ROLLER_BLADE || obj->otyp == DIFFICULT_BOOTS || obj->otyp == AIRSTEP_BOOTS || obj->otyp == SYNTHETIC_SANDALS || obj->otyp == BRIGHT_CYAN_BEAUTIES || obj->otyp == MARLENA_HIKING_BOOTS || obj->otyp == ANASTASIA_DANCING_SHOES || obj->otyp == JESSICA_LADY_SHOES || obj->otyp == SOLVEJG_MOCASSINS || obj->otyp == LUDGERA_HIKING_BOOTS || obj->otyp == KATI_GIRL_BOOTS || obj->otyp == KARIN_LADY_SANDALS || obj->otyp == LAURA_WINTER_BOOTS || obj->otyp == KRISTINA_PLATFORM_SNEAKERS || obj->otyp == LOU_SNEAKERS || obj->otyp == ALMUT_SNEAKERS || obj->otyp == JIL_VELCRO_SHOES || obj->otyp == JANA_SNEAKERS || obj->otyp == KERSTIN_WOODEN_SANDALS || obj->otyp == KERSTIN_SNEAKERS) skill = P_SEXY_FLATS;
