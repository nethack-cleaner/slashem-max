...
struct obj *obj;
{
	...
	if(!obj->leashmon && number_leashed() >= MAXLEASHED) {
		You(FunnyHallu ? "futilely try to leash" : "cannot leash any more pets.");
		return;
	}
