...
boolean dresistance;	/* level drain resistance can protect you */
{
	...
	/* In Soviet Russia, level drain will always drain at least one level, because you, stupid player. You're
...
{		/*	(false for potion of gain level)      */
	...
	/* a.k.a. "downside that every fun new race gets" (term coined by Khor) */
			...
			if (climintcheck) { /* keyword "marlena" */
				switch (whichcheck) {
					...
					case 3:
						...
						break;
					case 4:
						pline("You receive an elaborate auspicious message: At experience level %d, random traps will start spawning and you trigger them even if you fly.", displaycheck);
						break;
					case 5:
					...
					case 9:
						...
						break;
					case 10:
						pline("You receive an elaborate auspicious message: At experience level %d, walking over a toilet, your strength and dexterity are reduced, and monsters can use toilets to paralyze you.", displaycheck);
						break;
					case 11:
					...
					case 32:
						...
						break;
					case 33:
						pline("You receive an elaborate auspicious message: At experience level %d, perfume monsters will spawn much more frequently, and you trigger traps even if you fly.", displaycheck);
						break;
					case 34:
					...
					case 42:
						...
						break;
					case 43:
						pline("You receive an elaborate auspicious message: At experience level %d, you sometimes fumble into a heap, even if you fly.", displaycheck);
						break;
					case 44:
					...
					case 57:
						...
						break;
					case 58:
						pline("You receive an elaborate auspicious message: At experience level %d, you have to step.", displaycheck);
						break;
					case 59:
					...
					case 60:
						...
						break;
					case 61:
						pline("You receive an elaborate auspicious message: At experience level %d, bosses will challenge you to a duel.", displaycheck);
						break;
					case 62:
						...
						break;
					case 63:
						pline("You receive an elaborate auspicious message: At experience level %d, you have to watch out because there might be heaps where you don't expect them.", displaycheck);
						break;
					case 64:
