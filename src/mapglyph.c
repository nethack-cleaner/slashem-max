...
#ifdef TEXTCOLOR
#define zap_color(n)  color = iflags.use_color ? (everythingfleecy() ? rnd(15) : (uarmg && uarmg->oartifact == ART_JONADAB_S_KEYCODE && !rn2(5)) ? rnd(15) : ((uarmc && itemhasappearance(uarmc, APP_FLEECELING_CLOAK)) && !rn2(5) ) ? rnd(15) : (uarmh && uarmh->oartifact == ART_BLUE_SCREEN_OF_DEATH) ? CLR_BRIGHT_BLUE : (BlackNgWalls || (uamul && uamul->oartifact == ART_BLACK_DARKNESS) || u.uprops[BLACK_NG_WALLS].extrinsic ) ? CLR_BLACK : (FemtrapActiveMarlena && !rn2(10) ) ? (rn2(2) ? CLR_GREEN : CLR_BRIGHT_GREEN) : (uamul && uamul->oartifact == ART_FLEECY_GREEN) ? CLR_GREEN : (SpellColorGreen) ? CLR_GREEN : zapcolors[n]) : NO_COLOR
#define cmap_color(n) color = iflags.use_color ? (everythingfleecy() ? rnd(15) : (uarmg && uarmg->oartifact == ART_JONADAB_S_KEYCODE && !rn2(5)) ? rnd(15) : ((uarmc && itemhasappearance(uarmc, APP_FLEECELING_CLOAK)) && !rn2(5) ) ? rnd(15) : (uarmh && uarmh->oartifact == ART_BLUE_SCREEN_OF_DEATH) ? CLR_BRIGHT_BLUE : (BlackNgWalls || (uamul && uamul->oartifact == ART_BLACK_DARKNESS) || u.uprops[BLACK_NG_WALLS].extrinsic ) ? CLR_BLACK : (FemtrapActiveMarlena && !rn2(10) ) ? (rn2(2) ? CLR_GREEN : CLR_BRIGHT_GREEN) : (uamul && uamul->oartifact == ART_FLEECY_GREEN) ? CLR_GREEN : (SpellColorGreen) ? CLR_GREEN : defsyms[n].color) : NO_COLOR
#define obj_color(n)  color = iflags.use_color ? (everythingfleecy() ? rnd(15) : (uarmg && uarmg->oartifact == ART_JONADAB_S_KEYCODE && !rn2(5)) ? rnd(15) : ((uarmc && itemhasappearance(uarmc, APP_FLEECELING_CLOAK)) && !rn2(5) ) ? rnd(15) : (uarmh && uarmh->oartifact == ART_BLUE_SCREEN_OF_DEATH) ? CLR_BRIGHT_BLUE : (BlackNgWalls || (uamul && uamul->oartifact == ART_BLACK_DARKNESS) || u.uprops[BLACK_NG_WALLS].extrinsic ) ? CLR_BLACK : (FemtrapActiveMarlena && !rn2(10) ) ? (rn2(2) ? CLR_GREEN : CLR_BRIGHT_GREEN) : (uamul && uamul->oartifact == ART_FLEECY_GREEN) ? CLR_GREEN : (SpellColorGreen) ? CLR_GREEN : ((uarm && uarm->oartifact == ART_GRAYSCALE_WANDERER) || (uwep && uwep->oartifact == ART____SHADES_OF_GRAYSWANDIR) || (u.twoweap && uswapwep && uswapwep->oartifact == ART____SHADES_OF_GRAYSWANDIR) || (uamul && uamul->oartifact == ART_COLORLESS_VARIETY) || u.uprops[SHADES_OF_GREY].extrinsic || isblait) ? ( (objects[n].oc_color == CLR_RED) ? CLR_BLACK : (objects[n].oc_color == CLR_BROWN) ? CLR_BLACK : (objects[n].oc_color == CLR_BLUE) ? CLR_BLACK : (objects[n].oc_color == CLR_GREEN) ? CLR_GRAY : (objects[n].oc_color == CLR_MAGENTA) ? CLR_GRAY : (objects[n].oc_color == CLR_CYAN) ? CLR_GRAY : (objects[n].oc_color == CLR_BRIGHT_BLUE) ? CLR_GRAY : (objects[n].oc_color == CLR_YELLOW) ? CLR_WHITE : (objects[n].oc_color == CLR_ORANGE) ? CLR_WHITE : (objects[n].oc_color == CLR_BRIGHT_GREEN) ? CLR_WHITE : (objects[n].oc_color == CLR_BRIGHT_MAGENTA) ? CLR_WHITE : (objects[n].oc_color == CLR_BRIGHT_CYAN) ? CLR_WHITE : objects[n].oc_color) : objects[n].oc_color) : NO_COLOR
#define mon_color(n)  color = iflags.use_color ? (everythingfleecy() ? rnd(15) : (uarmg && uarmg->oartifact == ART_JONADAB_S_KEYCODE && !rn2(5)) ? rnd(15) : ((uarmc && itemhasappearance(uarmc, APP_FLEECELING_CLOAK)) && !rn2(5) ) ? rnd(15) : (uarmh && uarmh->oartifact == ART_BLUE_SCREEN_OF_DEATH) ? CLR_BRIGHT_BLUE : (BlackNgWalls || (uamul && uamul->oartifact == ART_BLACK_DARKNESS) || (uarmc && itemhasappearance(uarmc, APP_COLORFADE_CLOAK) ) || u.uprops[BLACK_NG_WALLS].extrinsic ) ? CLR_BLACK : (FemtrapActiveMarlena && !rn2(10) ) ? (rn2(2) ? CLR_GREEN : CLR_BRIGHT_GREEN) : (uamul && uamul->oartifact == ART_FLEECY_GREEN) ? CLR_GREEN : (SpellColorGreen) ? CLR_GREEN : ( ((uarm && uarm->oartifact == ART_GRAYSCALE_WANDERER) || (uwep && uwep->oartifact == ART____SHADES_OF_GRAYSWANDIR) || (u.twoweap && uswapwep && uswapwep->oartifact == ART____SHADES_OF_GRAYSWANDIR) || (uamul && uamul->oartifact == ART_COLORLESS_VARIETY) || u.uprops[SHADES_OF_GREY].extrinsic || isblait) && Infravision) ? ( (mons[n].mcolor == CLR_RED) ? CLR_BLACK : (mons[n].mcolor == CLR_BROWN) ? CLR_BLACK : (mons[n].mcolor == CLR_BLUE) ? CLR_BLACK : (mons[n].mcolor == CLR_GREEN) ? CLR_GRAY : (mons[n].mcolor == CLR_MAGENTA) ? CLR_GRAY : (mons[n].mcolor == CLR_CYAN) ? CLR_GRAY : (mons[n].mcolor == CLR_BRIGHT_BLUE) ? CLR_GRAY : (mons[n].mcolor == CLR_YELLOW) ? CLR_WHITE : (mons[n].mcolor == CLR_ORANGE) ? CLR_WHITE : (mons[n].mcolor == CLR_BRIGHT_GREEN) ? CLR_WHITE : (mons[n].mcolor == CLR_BRIGHT_MAGENTA) ? CLR_WHITE : (mons[n].mcolor == CLR_BRIGHT_CYAN) ? CLR_WHITE : mons[n].mcolor) : (mons[n].mflags4 & M4_MULTIHUED) ? rnd(15) : mons[n].mcolor) : NO_COLOR
#define invis_color(n) color = NO_COLOR
#define pet_color(n)  color = iflags.use_color ? (everythingfleecy() ? rnd(15) : (uarmg && uarmg->oartifact == ART_JONADAB_S_KEYCODE && !rn2(5)) ? rnd(15) : ((uarmc && itemhasappearance(uarmc, APP_FLEECELING_CLOAK)) && !rn2(5) ) ? rnd(15) : (uarmh && uarmh->oartifact == ART_BLUE_SCREEN_OF_DEATH) ? CLR_BRIGHT_BLUE : (BlackNgWalls || (uamul && uamul->oartifact == ART_BLACK_DARKNESS) || u.uprops[BLACK_NG_WALLS].extrinsic ) ? CLR_BLACK : (FemtrapActiveMarlena && !rn2(10) ) ? (rn2(2) ? CLR_GREEN : CLR_BRIGHT_GREEN) : (uamul && uamul->oartifact == ART_FLEECY_GREEN) ? CLR_GREEN : (SpellColorGreen) ? CLR_GREEN : ( ((uarm && uarm->oartifact == ART_GRAYSCALE_WANDERER) || (uwep && uwep->oartifact == ART____SHADES_OF_GRAYSWANDIR) || (u.twoweap && uswapwep && uswapwep->oartifact == ART____SHADES_OF_GRAYSWANDIR) || (uamul && uamul->oartifact == ART_COLORLESS_VARIETY) || u.uprops[SHADES_OF_GREY].extrinsic || isblait) && Infravision) ? ( (mons[n].mcolor == CLR_RED) ? CLR_BLACK : (mons[n].mcolor == CLR_BROWN) ? CLR_BLACK : (mons[n].mcolor == CLR_BLUE) ? CLR_BLACK : (mons[n].mcolor == CLR_GREEN) ? CLR_GRAY : (mons[n].mcolor == CLR_MAGENTA) ? CLR_GRAY : (mons[n].mcolor == CLR_CYAN) ? CLR_GRAY : (mons[n].mcolor == CLR_BRIGHT_BLUE) ? CLR_GRAY : (mons[n].mcolor == CLR_YELLOW) ? CLR_WHITE : (mons[n].mcolor == CLR_ORANGE) ? CLR_WHITE : (mons[n].mcolor == CLR_BRIGHT_GREEN) ? CLR_WHITE : (mons[n].mcolor == CLR_BRIGHT_MAGENTA) ? CLR_WHITE : (mons[n].mcolor == CLR_BRIGHT_CYAN) ? CLR_WHITE : mons[n].mcolor) : (mons[n].mflags4 & M4_MULTIHUED) ? rnd(15) : mons[n].mcolor) : NO_COLOR
#define warn_color(n) color = iflags.use_color ? (everythingfleecy() ? rnd(15) : (uarmg && uarmg->oartifact == ART_JONADAB_S_KEYCODE && !rn2(5)) ? rnd(15) : ((uarmc && itemhasappearance(uarmc, APP_FLEECELING_CLOAK)) && !rn2(5) ) ? rnd(15) : (uarmh && uarmh->oartifact == ART_BLUE_SCREEN_OF_DEATH) ? CLR_BRIGHT_BLUE : (BlackNgWalls || (uamul && uamul->oartifact == ART_BLACK_DARKNESS) || u.uprops[BLACK_NG_WALLS].extrinsic ) ? CLR_BLACK : (FemtrapActiveMarlena && !rn2(10) ) ? (rn2(2) ? CLR_GREEN : CLR_BRIGHT_GREEN) : (uamul && uamul->oartifact == ART_FLEECY_GREEN) ? CLR_GREEN : (SpellColorGreen) ? CLR_GREEN : def_warnsyms[n].color) : NO_COLOR
#define explode_color(n) color = iflags.use_color ? (everythingfleecy() ? rnd(15) : (uarmg && uarmg->oartifact == ART_JONADAB_S_KEYCODE && !rn2(5)) ? rnd(15) : ((uarmc && itemhasappearance(uarmc, APP_FLEECELING_CLOAK)) && !rn2(5) ) ? rnd(15) : (uarmh && uarmh->oartifact == ART_BLUE_SCREEN_OF_DEATH) ? CLR_BRIGHT_BLUE : (BlackNgWalls || (uamul && uamul->oartifact == ART_BLACK_DARKNESS) || u.uprops[BLACK_NG_WALLS].extrinsic ) ? CLR_BLACK : (FemtrapActiveMarlena && !rn2(10) ) ? (rn2(2) ? CLR_GREEN : CLR_BRIGHT_GREEN) : (uamul && uamul->oartifact == ART_FLEECY_GREEN) ? CLR_GREEN : (SpellColorGreen) ? CLR_GREEN : explcolors[n]) : NO_COLOR
...
# endif
	...
	if (HAS_ROGUE_IBM_GRAPHICS && iflags.use_color) {
		...
		else if (BlackNgWalls || (uamul && uamul->oartifact == ART_BLACK_DARKNESS) || u.uprops[BLACK_NG_WALLS].extrinsic ) color = CLR_BLACK;
		...
		else if ((uarm && uarm->oartifact == ART_GRAYSCALE_WANDERER) || (uwep && uwep->oartifact == ART____SHADES_OF_GRAYSWANDIR) || (u.twoweap && uswapwep && uswapwep->oartifact == ART____SHADES_OF_GRAYSWANDIR) || (uamul && uamul->oartifact == ART_COLORLESS_VARIETY) || u.uprops[SHADES_OF_GREY].extrinsic || isblait ) {
			switch (color) {
				case CLR_RED:
				case CLR_BROWN:
				case CLR_BLUE:
	...
	ch = monsyms[(int)mons[glyph].mlet];
		...
		mtmp = m_at(x, y);
		if (mtmp && mtmp->isegotype && !mtmp->noegodisplay && !ThereIsNoLite) special |= MG_EGOTYPE;
