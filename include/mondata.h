...
#define saprovorous(ptr)	((ptr) == &mons[PM_GHOUL] || (ptr) == &mons[PM_LOL_WE_INVENTED_ANOTHER_GHAST] || (ptr) == &mons[PM_SAPROVOROUS_NYMPH] || (ptr) == &mons[PM_GHAST] || (ptr) == &mons[PM_CORPSEWORM] || (ptr) == &mons[PM_STINKING_ALIEN] || (ptr) == &mons[PM_DOSTICH] || (ptr) == &mons[PM_CHTO] || (ptr) == &mons[PM_GASTLY] || (ptr) == &mons[PM_PHANTOM_GHOST] || (ptr) == &mons[PM_HAUNTER] || (ptr) == &mons[PM_GENGAR])
#define saprovorousnumber(mnnm)	(mnnm == PM_GHOUL || mnnm == PM_LOL_WE_INVENTED_ANOTHER_GHAST || mnnm == PM_SAPROVOROUS_NYMPH || mnnm == PM_GHAST || mnnm == PM_CORPSEWORM || mnnm == PM_STINKING_ALIEN || mnnm == PM_GASTLY || mnnm == PM_PHANTOM_GHOST || mnnm == PM_HAUNTER || mnnm == PM_GENGAR)
